...
st.markdown(
    """
    <style>
    /* Imposta la larghezza massima della sidebar */
...
# Imposta la cartella base in base allo session_id
base_folder = f"Bundle&Set_{session_id}"
clear_old_data()
...
def run():
    ...
    st.sidebar.markdown(
        ...
        - 📁 **Efficient Organization:** Each session creates a unique folder to avoid conflicts. The final ZIP includes a folder named "Bundle&Set".
